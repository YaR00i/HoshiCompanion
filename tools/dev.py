...
def run_step(engine: str, log_dir: Path, label: str, args: list[str], timeout: int = 180) -> dict:
    ...
    if label in ['runtime', 'posture', 'shelf', 'shelf_windows', 'external_windows', 'edge_life', 'edge_views', 'cozy_windows', 'place', 'context', 'context_views', 'surface']:
...
def main() -> int:
    ...
    parser.add_argument('mode', choices=['check', 'import', 'test', 'smoke', 'preview', 'desktop', 'editor', 'walk', 'capture', 'posture', 'poses', 'shelf', 'shelf_windows', 'shelf_demo', 'external_windows', 'edge_life', 'edge_views', 'cozy_windows', 'place', 'context', 'context_views', 'surface'])
    ...
    stages = []
    if opts.mode in ['check', 'import', 'test', 'preview', 'desktop', 'editor', 'walk', 'capture', 'posture', 'poses', 'shelf', 'shelf_windows', 'shelf_demo', 'external_windows', 'edge_life', 'edge_views', 'cozy_windows', 'place', 'context', 'context_views', 'surface']:
